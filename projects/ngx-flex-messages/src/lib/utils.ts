import { FlexComponent, FlexBox, FlexButton, FlexImage, FlexIcon, FlexText, FlexSpan, FlexSeparator, FlexFiller, FlexSpacer, FlexBubble } from './model';
...
export default class Utils {
    ...
    static getFlexData(data: FlexComponent): FlexBox | FlexButton | FlexImage | FlexIcon | FlexText | FlexSpan | FlexSeparator | FlexFiller | FlexSpacer | any {
        switch (data.type) {
        case 'box':
